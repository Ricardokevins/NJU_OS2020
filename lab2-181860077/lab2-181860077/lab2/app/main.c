...
int uEntry(void) 
{
	...
	printf("printf test begin...\n");
 	...
 	printf("Bootblock loads me to the memory position of 0x100000, and Makefilealso tells me that I'm at the location of 0x100000. ");
 	printf("\\%%~!@#/(^&*()_+`1234567890-=...... ");
 	...
 	printf("I'm the %s of %s. %s 0x%x, %s 0x%x. ", "body", "the game","Bootblock loads me to the memory position of", 0x100000, "and Makefile alsotells me that I'm at the location of", 0x100000);
 	printf("\\%%~!@#/(^&*()_+`1234567890-=...... ");
 	printf("Now I will test your printf: ");
